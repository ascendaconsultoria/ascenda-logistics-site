...
## Arquitetura atual
Site estático multipágina em HTML/CSS/JS para máxima portabilidade, crawlabilidade e performance.
Configurações de formulário e telemetria ficam em `assets/js/config.js`.
